...
GLdouble chair_y = -75.0f, chair_s = 10.0f;
...
void display(void) // Here's Where We Do All The Drawing
{
	...
	//chair
	{
		...
		glColor3f(plum);
		glutSolidSphere(chair_s, 200, 100);
